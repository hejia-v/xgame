...
namespace Invector.CharacterController.Actions
{
    ...
    public class vLadderAction : vActionListener
    {
        ...
        void ResetPlayerSettings()
        {
            ...
            tpInput.cc.gameObject.transform.localEulerAngles = new Vector3(0f, tpInput.cc.gameObject.transform.eulerAngles.y, tpInput.cc.gameObject.transform.eulerAngles.z);
        }
